...
const contactInfo = [
  ...
  { icon: FaGithub, label: 'GitHub', value: 'Github', href: 'https://github.com/Afiroj313501' },
  { icon: FaLinkedin, label: 'LinkedIn', value: 'LinkedIn', href: 'https://www.linkedin.com/in/abdullah-firoj-900697375/' },
